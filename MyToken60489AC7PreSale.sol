...
import "./MyToken60489AC7.sol";

contract MyToken60489AC7PreSale {
    MyToken60489AC7 public token;
    ...
    function MyToken60489AC7PreSale(
        MyToken60489AC7 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken60489AC7(_token);
